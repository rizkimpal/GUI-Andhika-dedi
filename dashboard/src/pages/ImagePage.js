...
function ImagePage() {
  ...
  return (
    <>
      <div className=" md:h-full h-full w-full md:bg-[#cec9b3] bg-[#cec9b3] md:pb-0 pb-8">
        <HeaderComponent />
        <div className="flex justify-center mt-5">
        <img src={MyImage} alt="graph" />
        </div>
        <h1 className=" text-white font-medium text-3xl text-center ">Mau record dengan cara apa?</h1>
